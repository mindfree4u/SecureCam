     ...
     />
        ...
        <View style={styles.root}>
			<View style={styles.head}>
				<Text style={[styles.title2, {top:40, left:40, color:'#B6BED8'}]}>GGULB</Text>
				...
				<Image source={require('../images/home_left.png')} style={styles.img_left}/>
			</View>		
...
// 							onPress={() => setAddVisible(true)} >
				...
				<View style={styles.collect}>
					<View style={styles.col_grp}>
						<Image source={require('../images/collect.png')} style={styles.img_col}/>
		...
		<View style={styles.devices}>
            ...
            {NickName && (
             NickName.map((item, index) => (
				...
				<View style={[styles.rectangle, { top: 60 + index * offset }]}></View>
				<View style={[styles.rectangle0, { top: 62 + index * offset }]}></View>
				
				
				<View style={[styles.dummy1,{ top: 140 + index * offset }]}/>



                <TouchableOpacity  style={{ position: 'absolute',  left:30,   top: 20 + index * offset }}
                                   onPress={() => handleImagePress(item)}>
                    <Image style={{ width: 32, height: 32 }} source={(Favorites[index] ==='Y' ? require('../images/FullStar.png') : require('../images/star2.png'))}/>
                </TouchableOpacity>
				
				<Text style={[styles.text0, { position: 'absolute',  left:65, top: 10 + index * offset }]}>NVR</Text>
                <Text style={[styles.text1, { position: 'absolute',  left:65, top: 30 + index * offset }]}>{item}</Text>
                <TouchableOpacity style={[styles.Rectangle1, { position: 'absolute',  left:250, top: 20 + index * offset }]}
                                  onPress={() => handleShareBtn(item) }>
                    <Image source={require('../images/share.png')} style={styles.img_share}/>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.Rectangle1, { position: 'absolute', left:290, top: 21 + index * offset }]}
                              onPress={() =>  navigation.navigate('Page_15000', {address: Address[index], nickname: NickName[index], port:Port[index] })}>
                    <Image source={require('../images/setup.png')} style={styles.img_share}/>
                </TouchableOpacity>
				
				
                <TouchableOpacity style={[styles.Rectangle2, { position: 'absolute',  left:'19%', top: 78 + index * offset }]}
                                  onPress={() => Linking.openURL('company://LivePreview')}>
					<View style={styles.col_grp}>
							<Image source={require('../images/live.png')} style={styles.img_col}/>
							<Text style={styles.text2}>LIVE</Text>
					</View>
                </TouchableOpacity>
				
                <TouchableOpacity style={[styles.Rectangle2, { position: 'absolute',  right:'23%', top: 78 + index * offset }]}
                                  onPress={()=> Linking.openURL('company://Page_17000')}>
					<View style={styles.col_grp}>
						<Image source={require('../images/playback.png')} style={styles.img_col}/>
...
img: {
	flex:1,
	position: 'absolute', right: 25, top: 1,
	width: 140, 
	height: 140,
},
...
add_grp: {
	flex:0.5,
	position: 'relative', left: '3.5%',  top: 125,
	width: '85%',
	padding: 20,
    flexDirection: 'row',
...
plus1: {
	position: 'relative', left: 20, top: -2,
    fontStyle: 'normal',
	color: '#FFFFFF',
	fontSize: 28,
	fontWeight: 500,
...
add1: {
	position: 'relative', left: 24, top: -5,
...
add2: {
	position: 'relative', left: 8, top: -2,
	fontFamily: 'Gothic A1',
    fontStyle: 'normal',
	color: '#FFFFFF',
	fontSize: 14,
...
text2: {
	position: 'relative', left:10, top:-2,
    fontFamily: 'Gothic A1',
    fontStyle: 'normal',
    fontWeight: 700,
    fontSize: 18,
