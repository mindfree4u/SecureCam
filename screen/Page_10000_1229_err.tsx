...
//        hidden={hidden}
	...
	<View style={styles.root}>
		...
		<View style={[styles.head, {flex:0.28}]}>
			<View>
		...
		<View style={[styles.devices, {flex:0.75}]}>
			<ScrollView>
				<View style={{height: 500}}>
					...
					{NickName && (
					 NickName.map((item, index) => (
						...
						<View style={[styles.rectangle, { top: 70 + index * offset }]}></View>
						<View style={[styles.rectangle0, { top: 72 + index * offset }]}></View>
						
						<View style={[styles.dummy1,{ top: 150 + index * offset }]}/>

						<TouchableOpacity  style={{ position: 'absolute',  left:30,   top: 25 + index * offset }}
										   onPress={() => handleImagePress(item)}>
							<Image style={{ width: 32, height: 32 }} source={(Favorites[index] ==='Y' ? require('../images/FullStar.png') : require('../images/star2.png'))}/>
						</TouchableOpacity>
						
						<Text style={[styles.text0, { position: 'absolute',  left:65, top: 15 + index * offset }]}>NVR</Text>
						<Text style={[styles.text1, { position: 'absolute',  left:65, top: 35 + index * offset }]}>{item}</Text>
						<TouchableOpacity style={[styles.Rectangle1, { position: 'absolute',  left:250, top: 25 + index * offset }]}
										  onPress={() => handleShareBtn(item) }>
							<Image source={require('../images/share.png')} style={styles.img_share}/>
						</TouchableOpacity>
						<TouchableOpacity style={[styles.Rectangle1, { position: 'absolute', left:290, top: 26 + index * offset }]}
						...
						<TouchableOpacity style={[styles.Rectangle2, { position: 'absolute',  left:'15%', top: 90 + index * offset }]}
							...
							<View style={styles.col_grp}>
									...
									<View style={[styles.center_bar, { left: 30 }]}></View>
							</View>
						</TouchableOpacity>
						
						<TouchableOpacity style={[styles.Rectangle2, { position: 'absolute',  right:'23%', top: 90 + index * offset }]}
...
add_grp: {
	position: 'relative', top: 225, left: 24, right: 24,
	width: '87%',
	padding: 23,
    flexDirection: 'row',
    alignItems: 'center',
