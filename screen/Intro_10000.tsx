  ...
  return (
	...
	//        hidden={hidden}
		 ...
		 <View style={styles.root}>
			...
			<Dialog.Container visible={idVisible} contentStyle={styles.dialogContent}>
				 ...
				 <Dialog.Description style={{top:-25, textAlign: 'center', fontSize: 16, fontWeight: 700}} >로그인 실패</Dialog.Description>
				 <Dialog.Description style={{top:-35, textAlign: 'center', fontSize: 15, fontWeight: 400}} >이메일 주소를 입력해 주세요.</Dialog.Description>
					<View style={styles.yes_no_btn}>
						<View style={styles.yes_btn}>
							<TouchableOpacity onPress={() => setIdVisible(false)} >
								<Text style={styles.confirm_text}>확인</Text>
							</TouchableOpacity>
						</View>
					</View>
				</Dialog.Container>
...
checkbox:{
   position: 'absolute', left: 34, top: 385,
   color: '#000000',
},

이메일저장:{
    position: 'absolute', left: 64, top: 394,
