...
const Page_13400 = ({ navigation, route }) => {
        ...
        <View>
			<View style={styles.intro}>
				<TouchableOpacity onPress={() => navigation.goBack()}>
					...
					<Text style={styles.장치추가}>온라인검색 장치추가</Text>
				</TouchableOpacity>
			</View>
			...
			<View style={styles.top_grp}>
				<Image source={require('../images/device_not_exist.png')} style={styles.passwd_init_ok_img}/>
				<Text style={styles.question}>검색된 장치가 없습니다.</Text>
				<Text style={styles.text1}>다시 시도해주세요.</Text>


				
			</View>
			
			<TouchableOpacity style={styles.Component1} onPress={() => navigation.navigate('Page_13200')}  >
					<Text style={styles.text3}>장치추가로 돌아가기</Text>
			</TouchableOpacity>
...
장치추가: {
    position: 'absolute', left: 106, top: 11,
