  ...
  return (
	...
	<View >
		...
		<View style={[{backgroundColor: '#FFFFFF', height: 600}]}>
			<View style={[styles.centerline, {top: 120, width: '100%'}]} />
				
			<Text style={[styles.text1, {top:140, left: '26%'}]}>새로운 공유계정 추가</Text>
			<Text style={[styles.text1, {top:175, left: 24, fontSize: 14, lineHeight: 20}]}>추가할 ID</Text>
...
textinput: {
    position: 'absolute', left: 24, right: 24, top: 210, 
    fontFamily: 'Inter',
    fontStyle: 'normal',
    fontWeight: '400',
    fontSize: 14,
...
Component1: {
    position: 'absolute', top: 730, left: 24, right: 24, bottom:50, height: 44,
    justifyContent: 'center',
