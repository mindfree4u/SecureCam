...
const Intro_11000styles = StyleSheet.create({
root: {
...
Component3: {
    position: 'absolute', left: '11.11%', right: '11.11%', top: 700, height: 45.13,
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: '#000000',
...
text5: {
    position: 'absolute', left: 40, top: 217,
...
export default Intro_11000styles;