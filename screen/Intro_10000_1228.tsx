...
//        hidden={hidden}
   ...
   <View >
     ...
     <View style={styles.root}>
	  ...
	  <Text style={[{top: 84, left: 40, color:'#B6BED8', fontSize: 16, fontWeight: 700, fontFamily: 'Pretendard'}]}>GGULB</Text>
	  <View style={styles.title_grp}>
         <Text style={styles.title}>Secure Cam</Text>
         <Text style={styles.welcome}>방문을 환영합니다.</Text>
      </View>
      <View style={styles.email_grp}>
         <Text style={styles.email}>E-mail</Text>
         <TextInput style={[styles.text_input, { top: 14}]} value={email} onChangeText={setEmail}
                           placeholder="ggulb@ggulb.net" placeholderTextColor="#C0C0C0" />

      </View>
	  <View style={[styles.line, {top: 294, left:'11.11%', right: '11.11%',width:'78.78%'}]}/>
      <View style={styles.passwd_grp}>
         <Text style={styles.password}>Password</Text>
         <TextInput style={[styles.text_input,  {top: 14}]} value={password}
                  onChangeText={handlePassword} secureTextEntry={true}
                  placeholder="비밀번호를 입력해주세요." placeholderTextColor="#C0C0C0"/>

      </View>
	  <View style={[styles.line, {top: 360, left:'11.11%', right: '11.11%',width:'78.78%'}]}/>

	<View style={styles.email_confirm}>
	    <CheckBox style={[styles.checkbox, {top:1}]}
      ...
      <View style={styles.bottom} >
         ...
         <TouchableOpacity style={[styles.Component2, {top:717}]} onPress={() => navigation.navigate('Intro_11000')}>
...
img: {
	flex:1,
	position: 'absolute', right:20, top: 1,
	width: 152, 
	height: 152,
},
...
email_grp: {
    position: 'absolute', left: 40, right: 40, top: 260,
 },
...
passwd_grp: {
    position: 'absolute', left: 40, right: 40, top: 330,
 },
...
passwd_square:{
    position: 'relative', left: 0, bottom:18,
...
email_confirm: {
   flexDirection: 'row',
   position: 'absolute', left: '10%', top: 400,
},
...
Component1: {
    position: 'absolute', left: '11.11%', width: '80%', top: 450, height: 44,
    display: 'flex',
...
Component2: {
    position: 'absolute', left: '11.11%', right: '11.11%', top: 450, height: 44,
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: '#FFFFFF',
...
text1:{
    position: 'relative', left: 0, top: 680,
    fontFamily: 'Gothic A1',
    fontStyle: 'normal',
    fontWeight: 400,
    fontSize: 14,
