   ...
   <View >
     ...
     <View style={styles.root}>
	  ...
	  <View style={styles.title_grp}>
         ...
         <Text style={styles.login}>방문을 환영합니다.</Text>
      </View>
      <View style={styles.email_grp}>
         <Text style={styles.email}>E-mail</Text>
         <TextInput style={styles.text_input} value={email} onChangeText={setEmail}
                           placeholder="ggulb@ggulb.net" placeholderTextColor="#4F4F4F" />
         <View style={styles.email_square}/>
      </View>
      ...
      <View style={styles.passwd_grp}>
         ...
         <View style={styles.passwd_square} />
      </View>
...
email_grp: {
    position: 'absolute', left: 40, right: '11.5%', top: 260,
 },
...
text_input: {
   position: 'relative', left: 0, bottom: 9,
    fontFamily: 'Inter',
    fontStyle: 'normal',
    fontWeight: '400',
    fontSize: 14,
...
passwd_grp: {
    position: 'absolute', left: 40, right: '11.5%', top: 330,
 },
...
email_confirm: {
   flexDirection: 'row',
   position: 'absolute', left: 40, top: 395,
},
...
Component1: {
    position: 'absolute', left: '11.11%', right: '11.5%', top: 450, height: 44,
    display: 'flex',
...
Component2: {
    position: 'absolute', left: 40, right: '11.5%', top: 695, height: 44,
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: '#FFFFFF',
   borderColor:'#808DD0',
...
text1:{
    position: 'relative', left: 0, top: 670,
    fontFamily: 'Pretendard',
    fontStyle: 'normal',
    fontWeight: 400,
    fontSize: 14,
