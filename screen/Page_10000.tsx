...
//        hidden={hidden}
	...
	<View style={styles.root}>
		...
		<View style={[styles.devices, {flex:0.59}]}>
			<ScrollView>
				<View style={{height: 500}}>
					...
					{NickName && (
					 NickName.map((item, index) => (
						...
						<TouchableOpacity style={[styles.Rectangle1, { position: 'absolute',  left:'70%', top: 25 + index * offset }]}
										  onPress={() => handleShareBtn(item) }>
							<Image source={require('../images/share.png')} style={styles.img_share}/>
						</TouchableOpacity>
						<TouchableOpacity style={[styles.Rectangle1, { position: 'absolute', left:'78%', top: 26 + index * offset }]}
